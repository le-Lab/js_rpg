...
const checkClass = (hero, characterClass) => {
  ...
  switch (lowerCharacterClass){
    ...
    case `voleur`:
      ...
      break
    default:
      characterClass = prompt(`"${characterClass}" n'est pas une classe valide. Veuillez choisir une autre classe`)
...
const checkRace = (hero, race) => {
  ...
  switch (lowerCaseRace) {
    ...
    case `demi-homme`:
      ...
      break
    default:
      race = prompt(`${race} n'est pas une race valide. Veuillez choisir une nouvelle race`)
      hero.race = race
      checkRace(hero, race)
      break
  }
